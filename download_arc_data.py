...
if os.path.exists(arcgen_dataset_path) and os.listdir(arcgen_dataset_path):
    print(
        f"Dataset '{arcgen_dataset_name}' already exists in '{arcgen_dataset_path}'. Skipping download."
    )
else:
...
if os.path.exists(rearc_dataset_path) and os.listdir(rearc_dataset_path):
    print(
        f"re-arc dataset already exists in '{rearc_dataset_path}'. Skipping download."
    )
else:
...
if os.path.exists(competition_dataset_path) and os.listdir(competition_dataset_path):
    print(
        f"Competition '{kaggle_competition}' already exists in '{competition_dataset_path}'. Skipping download."
    )
else:
...
if os.path.exists(github_dataset_path) and os.listdir(github_dataset_path):
    print(
        f"ARC-AGI dataset already exists in '{github_dataset_path}'. Skipping download."
    )
else:
...
if os.path.exists(heavy_dataset_path) and os.listdir(heavy_dataset_path):
    print(
        f"ARC HEAVY dataset already exists in '{heavy_dataset_path}'. Skipping download."
    )
else:
...
conceptarc_zip_url = (
    "https://github.com/victorvikram/ConceptARC/archive/refs/heads/main.zip"
)
...
if os.path.exists(conceptarc_dataset_path) and os.listdir(conceptarc_dataset_path):
    print(
        f"ConceptARC dataset already exists in '{conceptarc_dataset_path}'. Skipping download."
    )
else:
