...
def evaluate_denoising_accuracy(
    ...
    """Evaluate denoising accuracy by generating output grids from random initialization.
    ...
    # Generate output grid from random initialization
...
def compute_loss_for_batch(
    ...
    Args:
        ...
        batch: Batch of tokens, shape (batch_size, 50) - input grid (25) + output grid (25)
        task_indices: Task indices of shape (batch_size,)
...
def main():
    ...
    config = Config(
        ...
        output_dir=Path("output/mini_arc_fsq"),
        test_ratio=0.2,
        random_seed=42,
